...
{
   idd = 7770;
   onKeyDown = "if (_this select 1 isEqualTo 0x01) then { [] ExecVM 'scripts\jstar_scripts\ServerInfoMenu\sqf\onEscape.sqf' }; true";
   onLoad = "uiNamespace setVariable ['RscDisplayServerInfoMenu', _this select 0]; [] ExecVM 'scripts\jstar_scripts\ServerInfoMenu\sqf\onLoad.sqf'; playSound ['ZoomIn', true]; 'DynamicBlur' ppEffectEnable true; 'DynamicBlur' ppEffectAdjust [7]; 'DynamicBlur' ppEffectCommit 0.1";
   ...
   class controls
   {
      ...
      class menu:RscListbox
      {
         ...
         idc = 7;
         onLBSelChanged = "[] ExecVM 'scripts\jstar_scripts\ServerInfoMenu\sqf\handleContent.sqf'";
      };
