["Unflipping vehicle in 5 seconds stand back! (Stay within 20 metres)"] call JSt4r_fnc_notification_system;
sleep 5;
...
["Vehicle Unflipped"] call JSt4r_fnc_notification_system;